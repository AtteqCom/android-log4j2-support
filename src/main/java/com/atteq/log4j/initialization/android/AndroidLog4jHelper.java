...
public class AndroidLog4jHelper {
	...
	public static void initialise(Context context, int configResource) {
		...
		injectPlugins("com.nasquan.opalsense.app.utility",
				new Class<?>[] { AndroidLookup.class, LogcatAppender.class });
		org.apache.logging.log4j.LogManager.setFactory(new Log4jContextFactory(new AndroidContextSelector()));
	}
